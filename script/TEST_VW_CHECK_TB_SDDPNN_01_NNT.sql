-- Start of DDL Script for View TEST.VW_CHECK_TB_SDDPNN_01_NNT
-- Generated 03/10/2013 2:29:31 PM from TEST@DCNC
...
SELECT   short_name,
 ...
 WHERE   short_name = pck_glb_variables.get_short_name
         ...
         OR (thd_dtich_dung_md NOT IN (SELECT   ma_muc_dich FROM tb_pnn_dm_muc_dich_sd)
             AND thd_gcn = 1)
UNION
...
-- End of DDL Script for View TEST.VW_CHECK_TB_SDDPNN_01_NNT
